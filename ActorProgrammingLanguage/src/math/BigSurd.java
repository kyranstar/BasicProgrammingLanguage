...
public class BigSurd implements Cloneable, Comparable<BigSurd> {
     ...
     * The value of zero.
     */
    public static final BigSurd ZERO = new BigSurd();
    
    /**
     * The value of one.
     */
    public static final BigSurd ONE = new BigSurd(Rational.ONE, Rational.ONE);
     ...
     * @since 2011-02-12
     */
    public BigSurd divide(final int val) {
        if (val == 0) {
            throw new ArithmeticException("Dividing " + toString()
                    + " through zero.");
        }
    ...
    public boolean isBigInteger() {
        return pref.isBigInteger()
                && (disc.signum() == 0 || disc.compareTo(Rational.ONE) == 0);
    ...
    public Rational toRational() {
        if (isRational()) {
            ...
            throw new ArithmeticException("Undefined conversion " + toString()
                    + " to Rational.");
        }
    } /* BigSurd.toRational */
     ...
     * @since 2011-02-12
     */
    protected final void normalizeG() {
        /*
    ...
    public BigDecimal bigDecimalValue(final MathContext mc) {
         ...
         */
        final MathContext locmc = new MathContext(mc.getPrecision() + 3,
                mc.getRoundingMode());
        /*
         * first the square root of the discriminant
         */
        final BigDecimal sqrdis = BigDecimalMath.sqrt(
                disc.bigDecimalValue(locmc), locmc);
        /*
