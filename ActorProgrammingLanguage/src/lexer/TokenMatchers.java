...
public class TokenMatchers {
    ...
    public static class SPACE extends TokenMatcher {
        ...
        /* (non-Javadoc)
         * @see lexer.TokenMatcher#getTokenNoCheck(java.lang.String, lexer.LexerInformation)
         */
        @Override
        ...
        /* (non-Javadoc)
         * @see lexer.TokenMatcher#matchesNoCheck(java.lang.String, lexer.LexerInformation)
         */
        @Override
